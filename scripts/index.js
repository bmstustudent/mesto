...
//         likeTarget.classList.toggle('cards__like-active');
//     });
// });

// //popup zoom image
// let figurePhoto = document.querySelectorAll('.cards__image');
...
//         const figureCard = figurePhotoTarget.closest('.cards__item');
//         popupImageText.textContent = figureCard.querySelector('.cards__title').textContent;
//     });
// });
